...
public class trang_ve_da_mua extends BaseActivity<ActivityTrangVeDaMuaBinding> {
    ArrayList<VeDaMua> listEvent;
    VeDaMuaAdapter adapter;

    @Override
    protected ActivityTrangVeDaMuaBinding inflateBinding() {
        return ActivityTrangVeDaMuaBinding.inflate(getLayoutInflater());
    }
